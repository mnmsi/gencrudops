...
class MakeMigrationService extends IOServices
{
    ...
    public function findAndReplaceMigration($columns, $migrationStub)
    {
        $fieldsMigration = '';
    ...
    public function makeCompleteMigrationFile($namingConvention, $columns)
    {
        ...
        $migrationStub = $this->findAndReplaceMigration($columns, $migrationStub);
