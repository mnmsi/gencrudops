...
class PathsAndNamespacesService
{
    ...
    public function getGencrudopsViewsStub()
    {
        return resource_path('gencrudops' . DIRECTORY_SEPARATOR . 'views');
    }

    public function getGencrudopsViewsStubCustom($templateViewsDirectory)
    {
        return $this->getGencrudopsViewsStub() . DIRECTORY_SEPARATOR . $templateViewsDirectory;
    }
}
