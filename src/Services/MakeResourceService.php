...
class MakeResourceService extends IOServices
{
    ...
    public function findAndReplaceResource($columns, $resourceStub)
    {
        ...
        foreach ($columns as $column) {
            ...
            // our placeholders
            $resourceArrayContent .= str_repeat("\t", 3) . "MakeResourceService.php" . trim($column) . "' => " . '$this->' . trim($column) . ",\n";
        }
    ...
    public function makeCompleteResourceFile($namingConvention, $columns, $laravelNamespace)
    {
        ...
        $resourceStub = $this->findAndReplaceResource($columns, $resourceStub);
