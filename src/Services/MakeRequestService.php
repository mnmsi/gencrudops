...
class MakeRequestService extends IOServices
{
    ...
    public function findAndReplaceRequest($columns, $requestStub)
    {
        $rules = '';
    ...
    public function makeCompleteRequestFile($namingConvention, $columns, $laravelNamespace)
    {
        ...
        $requestStub = $this->findAndReplaceRequest($columns, $requestStub);
